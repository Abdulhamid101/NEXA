...
function renderIcon(kind) {
  ...
  switch (kind) {
    case "medal":
      return p("M12 2l3 5 6 1-4 4 1 6-6-3-6 3 1-6-4-4 6-1 3-5Z");
    case "stack":
      return p(
        "M12 2 2 7l10 5 10-5-10-5Zm0 8L2 7v4l10 5 10-5V7l-10 3Zm0 6L2 13v4l10 5 10-5v-4l-10 3Z"
      );
    case "undo":
      return p("M12 5a7 7 0 1 1-5 2H5V4l-4 4 4 4V9h2a5 5 0 1 0 5-4Z");
    case "bridge":
      return p("M3 13h18v2H3v-2Zm2-4h2a7 7 0 0 1 10 0h2v2H5v-2Z");
    case "gas":
      return p("M15 3v2h-4v2H9v4h2v2h2v-2h2V7h2V5h-2V3h-2Z");
    case "wrench":
      return p("M21 7a5 5 0 0 1-7 4l-8 8H3v-3l8-8a5 5 0 1 1 10-1Z");
    default:
      return p("M12 2l10 5-10 5L2 7l10-5Z");
  }
}
